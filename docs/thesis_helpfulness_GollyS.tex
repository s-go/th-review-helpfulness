...
\begin{table}[h!]
	...
	\makebox[\linewidth]{
		\begin{tabular}{lcc}
		\thead{} & \thead{Reviews including\\ \lstinline|Expansion.Conjunction|} & \thead{Reviews without\\ \lstinline|Expansion.Conjunction|} \\ \hline
