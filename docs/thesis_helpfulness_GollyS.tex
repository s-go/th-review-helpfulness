...
\begin{figure}[h!]
\includegraphics[width=\textwidth, trim=2.5cm 17cm 3.5cm 2cm, clip]{img/pdtb-sense-hierarchy}
...
\bibitem[Webber et al.(2006)]{Webber2006} Webber, B., Joshi, A., Miltsakaki, E., Prasad, R., Dinesh, N., Lee, A., \& Forbes, K. (2006). A Short Introduction to the Penn Discourse TreeBank. \textit{Copenhagen Studies in Language}, 32(9).
